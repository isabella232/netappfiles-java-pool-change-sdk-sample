...
package poolchange.sdk.sample.common;
...
public class Utils
{
    ...
    {
        System.out.println("Azure NetAppFiles Java SDK Samples - Sample project that performs a pool change on a Volume using the Azure NetApp Files SDK");
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------");
        System.out.println("");
    }
